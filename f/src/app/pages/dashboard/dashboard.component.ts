...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, RouterModule, FormsModule,AddToPlaylistComponent,  SidebarComponent, PlaylistsComponent, RecentTracksComponent, RandomTracksComponent, MixesCapsuleComponent, AutoPlaylistsComponent, NavBar, PlayerBarComponent, RecommendationsComponent, CoverplayerComponent],
